namespace Agilent.OpenLab.CompoundGroups
{
    ...
    /// <summary>
    /// CompoundGroupsModule
    /// </summary>
    /// <remarks>
    /// </remarks>
    public partial class CompoundGroupsModule : BaseUIModule
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="CompoundGroupsModule"/> class.
        /// </summary>
        ...
        /// <remarks>
        /// </remarks>
        public CompoundGroupsModule(IUnityContainer container)
            : base(container)
        {
        }
        ...
        protected override void ExtendMenu()
        {
            ...
            {
                var viewModel = this.Container.Resolve<ICompoundGroupsViewModel>();
        ...
        {
            this.Container.RegisterType<ICompoundGroupsViewModel, CompoundGroupsViewModel>(
                new ContainerControlledLifetimeManager());
            this.Container.RegisterType<ICompoundGroupsView, CompoundGroupsView>(
                new ContainerControlledLifetimeManager());
            this.RegisterViewModel(this.Container.Resolve<ICompoundGroupsViewModel>());
            this.Container.Resolve<IRegionViewRegistry>().RegisterViewWithRegion(
                this.ModuleId, () => this.Container.Resolve<ICompoundGroupsViewModel>().View);
        }
