...
//        //        args = new string[2];
//        //        args[0] = @"C:\Users\harika\Desktop\D01B.d";
//        //        args[1] = @"C:\Users\harika\Desktop\D02B.d";
//        //        for (int argInd = 0; argInd < args.Length; argInd++)
//        //        {
//        //            string argument = args[argInd].Trim();

//        //            if (argument.EndsWith(".d", StringComparison.CurrentCultureIgnoreCase) || argument.EndsWith(".D", StringComparison.CurrentCultureIgnoreCase))
//        //            {
//        //                if (!System.IO.Path.IsPathRooted(argument))
//        //                {
//        //                    analysisFiles.Add(System.IO.Path.GetFullPath(argument));
//        //                }
//        //                else
//        //                {
//        //                    analysisFiles.Add(argument);
//        //                }
//        //            }
//        //            else
//        //            {
...
//        //            }
//        //        }
//        //        //string[] sItems = arguments.Split('*');
//        //        //analysisFiles.Add(sItems[0]);
//        //        //methodFileName = sItems[1];
//        //        ExecuteCommandLine(analysisFiles);
...
//            //catch (Exception e)
//            //{         
//            //    //m_messageReporter.ReportException(e);
//            //    DumpToLog();
//            //    exitcode = 1;
//            //    Application.Exit();
//            //}
...
//        //{
//        //    //m_messageReporter.ReportException(e.Exception);
...
//        //    qualAppLogic.TraceApplicationLog();
//        //    Agilent.MassSpectrometry.Utilities.MemoryTraceListener.DumpLog();
//        //}
...
//        //    if (exception  == null   )
//        //    {
//        //        //This non CLS compliant exception
//        //        //convert it to cls compliant
//        //        if( args.ExceptionObject != null )
//        //        {
//        //            exception = new Exception( 
//        //                String.Format( "A non-CLS-compliant exception of type {0} occured. Details {1}." ,
//        //                                args.ExceptionObject.GetType(), args.ExceptionObject.ToString()));
//        //        }
//        //        else
//        //        {
//        //            exception = new Exception( "Unknown non-CLS-compliant exception occured."); 
//        //        }

//        //    }

//        //    //m_messageReporter.ReportException(exception);
//        //    DumpToLog();
//        //}
...
//        /// </summary>
//        /// <param name="methodFile">Method to load if null uses worklist method</param>
//        /// <param name="scriptFile">script to run, if null runs worklist script</param>
//        /// <param name="analysisFiles">List of .d's can be an empty list</param>
...
//                //Setup application's thread error reporter
//                //appState.ThreadErrorReporter = m_messageReporter;

//                AnalysisMethodLoadOptions loadMethod = AnalysisMethodLoadOptions.LoadFromWorklist;
//                //if (methodFile != string.Empty)
//                //{
...
//                //    //From now on use currently loaded method
//                //    loadMethod = AnalysisMethodLoadOptions.UseCurrentlyLoaded; 
//                //}
//                // Open up analysis files
...
//                // If there is just one argument, the data file, then we can safely assume that we need to run
//                // method automation.
//                //var runMethodAutomation = (analysisFiles.Count == 1) && (args.Length == 1);
...
//                {
//                    foreach (IUserMessage userMessage in msdaExep.UserMessages)
//                    {
//                        //string message = String.Format(Resource.Error_Message_0,
//                        //    userMessage.Message);
//                        Console.WriteLine(userMessage);
//                    }                    
//                }
...
//        /// <summary>
//        /// Runs script in the given script file.
//        /// If scriptFile is null or string.Empty then runs worklist scripts
//        /// </summary>
//        /// <param name="qualAppLogic"></param>
//        /// <param name="scriptFile"></param>
//        /// <param name="args"></param>
//        /// <param name="runMethodAutomation">true to run method automation, or false otherwise</param>
//        private static void RunScript(AppManager qualAppLogic, string scriptFile, string[] args,
//            bool runMethodAutomation)
//        {

//            QualScriptParameters scriptParams = new QualScriptParameters();

//            IPSetRangeCollection rangeCollection =
//                qualAppLogic[QualDAMethod.ParamKeyAutomationSelectedTimeRanges]
//                    as IPSetRangeCollection;

//            if (rangeCollection.UseRanges)
//            {
//                scriptParams.SelectedRetentionTimes = rangeCollection.Ranges;
//            }

//            // Assign the input parameters to the script params so that they can be accessed from the script
//            scriptParams.ScriptInputArgs = args;

//            CmdRunScript cmdScript;

//            //if (runMethodAutomation)
//            //{
//            //    qualAppLogic.ScriptExecutionMode = ScriptMode.MethodAutomationScript;

//            //    // If running method automation, then invoke appropriate workflow script.
//            //    var exePath = Assembly.GetExecutingAssembly().Location;
//            //    var dllPath = Path.Combine(Path.GetDirectoryName(exePath),"QualWorkflow.dll");

//            //    scriptParams.ScriptInputArgs = new[] {"/all"};

//            //    cmdScript = new CmdRunScript(qualAppLogic,
//            //                                        QualScripts.ScriptFile,
//            //                                        scriptParams,
//            //                                        new[] { dllPath });
//            //}
//            if (string.IsNullOrEmpty(scriptFile))
//            {
//                qualAppLogic.ScriptExecutionMode = ScriptMode.SpecifiedScripts;

//                //Console.WriteLine("Running automation scripts..");
//                cmdScript = new CmdRunScript(qualAppLogic,
//                                                    QualScripts.AutomationScripts,
//                                                    scriptParams,
//                                                    null);
//            }
//            else
...
//                //script file is specified 
//                cmdScript = new CmdRunScript(qualAppLogic,
//                                                    QualScripts.ScriptFile ,
//                                                    scriptParams,
//                                                    new string[] { scriptFile  });
//            }


//            ExecuteCommand(  qualAppLogic,cmdScript);


//        }

//        static void OnAppProgressEvent(object sender, AppProgressEventArgs args)
//        {
//            for (int idx = 0; idx < args.AppProgressItems.Length; idx++)
//            {
//                AppProgressItem progress = args.AppProgressItems[idx];
