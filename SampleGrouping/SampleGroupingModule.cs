namespace Agilent.OpenLab.SampleGrouping
{
    ...
    /// <summary>
    /// SampleGroupingModule
    /// </summary>
    /// <remarks>
    /// </remarks>
    public partial class SampleGroupingModule : BaseUIModule
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="SampleGroupingModule"/> class.
        /// </summary>
        ...
        /// <remarks>
        /// </remarks>
        public SampleGroupingModule(IUnityContainer container)
            : base(container)
        {
        }
        ...
        protected override void ExtendMenu()
        {
            ...
            {
                var viewModel = this.Container.Resolve<ISampleGroupingViewModel>();
        ...
        {
            this.Container.RegisterType<ISampleGroupingViewModel, SampleGroupingViewModel>(
                new ContainerControlledLifetimeManager());
            this.Container.RegisterType<ISampleGroupingView, SampleGroupingView>(
                new ContainerControlledLifetimeManager());
            this.RegisterViewModel(this.Container.Resolve<ISampleGroupingViewModel>());
            this.Container.Resolve<IRegionViewRegistry>().RegisterViewWithRegion(
                this.ModuleId, () => this.Container.Resolve<ISampleGroupingViewModel>().View);
        }
