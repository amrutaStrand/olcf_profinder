namespace Agilent.OpenLab.TICPlot
{
    ...
    /// <remarks>
    /// </remarks>
    public partial class TICPlotModule : BaseUIModule
    {
        #region Constructors and Destructors

        /// <summary>
        /// Initializes a new instance of the <see cref="TICPlotModule"/> class.
        /// </summary>
        ...
        /// <remarks>
        /// </remarks>
        public TICPlotModule(IUnityContainer container)
            : base(container)
        {
        }
        ...
        protected override void ExtendMenu()
        {
            ...
            {
                var viewModel = this.Container.Resolve<ITICPlotViewModel>();
        ...
        {
            this.Container.RegisterType<ITICPlotViewModel, TICPlotViewModel>(
                new ContainerControlledLifetimeManager());
            this.Container.RegisterType<ITICPlotView, TICPlotView>(
                new ContainerControlledLifetimeManager());
            this.RegisterViewModel(this.Container.Resolve<ITICPlotViewModel>());
            this.Container.Resolve<IRegionViewRegistry>().RegisterViewWithRegion(
                this.ModuleId, () => this.Container.Resolve<ITICPlotViewModel>().View);
        }
